...
(function () {
  ...
  window.EB_SHEETS_CONFIG = {
    ...
    drustvo:       { source: src, file: "gsheet/drustvo.csv",        url: csv("1eKQ6aupML6rQRwZWggE8lpi0KGdsYyc1EPi_oZpQW0A") + "&headers=1" },
  ...
  window.EB_SHEETS_LINKS = {
    ...
    drustvo:       "https://docs.google.com/spreadsheets/d/1eKQ6aupML6rQRwZWggE8lpi0KGdsYyc1EPi_oZpQW0A/edit",
