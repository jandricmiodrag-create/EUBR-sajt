...
(function () {
  ...
  window.EB_SHEETS_CONFIG = {
    stranice:      { source: src, file: "gsheet/stranice.csv",       url: csv("1x9OeCOEh7WDnApDglCrWaDm4DFRjQNMLSjXKTqh2KOs") },
  ...
  window.EB_SHEETS_LINKS = {
    ...
    stranice:      "https://docs.google.com/spreadsheets/d/1x9OeCOEh7WDnApDglCrWaDm4DFRjQNMLSjXKTqh2KOs/edit",
