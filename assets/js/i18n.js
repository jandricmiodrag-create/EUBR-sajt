...
window.EB_I18N = {
  ...
  ui: {
    ...
    "home.mktTitle": { sr: "Birajte tržište", en: "Choose your market" },
    "home.mktSub": { sr: "Birajte između domaćeg tržišta i pristupa svjetskim berzama uz brokera koji svaki korak objašnjava.", en: "Choose between the domestic market and access to world exchanges, with a broker who explains every step." },
    "home.domH": { sr: "Domaće tržište", en: "Domestic market" },
    "home.domP": { sr: "Trgujte hartijama od vrijednosti na Banjalučkoj berzi uz direktnu podršku brokera.", en: "Trade securities on the Banja Luka Stock Exchange with direct broker support." },
    ...
    "home.worldP": { sr: "Pristupite globalnim akcijama, ETF-ovima i drugim dostupnim instrumentima na vodećim svjetskim tržištima kapitala.", en: "Access global equities, ETFs and other available instruments on the world's leading capital markets." },
  ...
  content: {
    ...
    "otvorite-racun": {
      ...
      steps: [
        { t: "Fill in the questionnaire", d: "Fill in and submit the client questionnaire and start the account-opening process.", cta: "Fill in the questionnaire", href: "https://script.google.com/macros/s/AKfycbzRgdBpOfkwgHTwg-JbalH9G0SxrVL_Dmmet9mlQcyyLd1s_mqK-ZrLrhMbwFWyuz2-7w/exec", ext: true, embed: true, embedTitle: "Eurobroker — Client questionnaire", fb: "If the questionnaire does not display correctly, open it in a new window" },
