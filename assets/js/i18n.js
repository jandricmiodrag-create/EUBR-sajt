...
window.EB_I18N = {
  ...
  ui: {
    ...
    "home.svcTitle": { sr: "Šest prihodnih linija pod jednim krovom", en: "Six business lines under one roof" },
    ...
    "home.mktTitle": { sr: "Jedan odnos. Dva investiciona pravca.", en: "One relationship. Two investment directions." },
    "home.mktSub": { sr: "Birajte između domaćeg tržišta i pristupa svjetskim berzama — uz brokersku podršku Eurobrokera.", en: "Choose between the domestic market and access to world exchanges — with Eurobroker's brokerage support." },
